  ...
  */
  ...
  listen(options, callback) {
    ...
    if(options.httpPort != undefined) {
      ...
      this.server.listen(options.httpPort, callback);
    }

    if(options.httpsPort != undefined && options.cert != undefined && options.key != undefined) {
      this.HTTPSserver = https.createServer(options, function(req, res) {
          self.handle(req, res);
      });
      this.HTTPSserver.listen(options.port, callback);
    }
  }
  /**
